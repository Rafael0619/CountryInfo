    ...
    return ( 
        <div className="row col-12 ">
            <div className="row col-10 justify-content-center text-align margin-auto" >
                ...
                <h2 className="col-6 direction-column"> <span className="color" > Temperature (°C):  </span> {(temp-273.15).toFixed(2)}°</h2>
                <h2 className="col-6 direction-column"> <span className="color" > Thermal Sensation:   </span>  {(thermal-273.15).toFixed(2)}</h2>
                <h2 className="col-6 direction-column"> <span className="color" > Humidity:  </span> {humidity}% </h2>
                <h2 className="col-6 direction-column"><span className="color" > Pressure (hPA) :  </span> {pressure}</h2>
                <h2 className="col-6 direction-column"> <span className="color" > Timezone:   </span>{timezones}</h2>
                <h2 className="col-6 direction-column"> <span className="color" >Visibility (m):    </span>{visibility}</h2>
                <h2 className="col-6 direction-column"> <span className="color" >Wind Degrees:   </span>{wind_deg}°</h2>
                <h2 className="col-6 direction-column"> <span className="color" >Wind Speed (km/h):    </span>{wind_speed}</h2>
                <Link to={`/`}>
